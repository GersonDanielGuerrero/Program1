...
public class DB extends SQLiteOpenHelper {
    ...
    private static final String SQldb = "CREATE TABLE Productos( idProducto txt,nombre text, descripcion text, marca text, presentacion text, precio text,foto text,id text,rev text)";
